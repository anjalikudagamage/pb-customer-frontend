...
const ReviewSection: React.FC = () => {
  return (
    <Box sx={{ padding: '40px', backgroundColor: '#e53935', textAlign: 'center' }}>
      <Typography variant="h4" sx={{ color: '#fff', fontWeight: 'bold', marginBottom: '10px' }}>
        THEY TRUSTED US
      </Typography>
      ...
      <Button variant="contained" color="primary" sx={{ backgroundColor: '#fff', color: '#e53935', fontWeight: 'bold', padding: '10px 30px', borderRadius: '20px' }}>
        SEE MORE
      </Button>
    </Box>
  );
